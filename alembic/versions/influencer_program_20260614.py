...
def upgrade() -> None:
    ...
    op.add_column("referral_code", sa.Column("commission_recurring", sa.Integer(), server_default="100", nullable=False))
    op.add_column("referral_code", sa.Column("commission_months", sa.Integer(), server_default="5", nullable=False))
    op.add_column("referral_code", sa.Column("bonus_invoices", sa.Integer(), server_default="0", nullable=False))
