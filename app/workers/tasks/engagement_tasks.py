    ...
    email_map = {
        ...
        3: (
            ...
            (
                ...
                "✅ Manual invoices — just 0.5% (min ₦50, about ₦500 per ₦100k) from your prepaid wallet\n\n"
...
def _send_monetization(db, user, name: str, invoice_count: int, stats: dict[str, int]) -> bool:
    ...
    if wallet_kobo <= 0 and not _was_sent(db, user.id, EMAIL_LIMIT_REACHED):
        ...
        body = (
            ...
            "invoices (just 0.5% each, min ₦50, about ₦500 per ₦100k) — or share your storefront so "
    ...
    # Wallet low (under ₦50)
        ...
        body = (
            ...
            "(0.5% per invoice, min ₦50, about ₦500 per ₦100k)."
        )
