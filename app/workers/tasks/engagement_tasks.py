    ...
    email_map = {
        ...
        3: (
            ...
            (
                ...
                "✅ Manual invoices — just 1% (min ₦100, ₦500 cap up to ₦500k) from your prepaid wallet\n\n"
...
def _send_monetization(db, user, name: str, invoice_count: int, stats: dict[str, int]) -> bool:
    ...
    if wallet_kobo <= 0 and not _was_sent(db, user.id, EMAIL_LIMIT_REACHED):
        ...
        body = (
            ...
            "invoices (just 1% each, min ₦100, ₦500 cap up to ₦500k) — or share your storefront so "
    ...
    # Wallet low (under ₦50)
        ...
        body = (
            ...
            "(1% per invoice, min ₦100, ₦500 cap up to ₦500k)."
        )
